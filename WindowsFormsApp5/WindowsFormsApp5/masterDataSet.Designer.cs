...
namespace WindowsFormsApp5 {
    ...
    public partial class masterDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientsDataTable : global::System.Data.TypedTableBase<ClientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientsRow AddClientsRow(string Surname, string FirstName, string Patronymic, string Address, string Telephone) {
...
namespace WindowsFormsApp5.masterDataSetTableAdapters {
    ...
    public partial class ClientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Clients] ([Surname], [FirstName], [Patronymic], [Address], [Telephone]) VALUES (@Surname, @FirstName, @Patronymic, @Address, @Telephone);
SELECT Id, Surname, FirstName, Patronymic, Address, Telephone FROM Clients WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clients] SET [Surname] = @Surname, [FirstName] = @FirstName, [Patronymic] = @Patronymic, [Address] = @Address, [Telephone] = @Telephone WHERE (([Id] = @Original_Id));
SELECT Id, Surname, FirstName, Patronymic, Address, Telephone FROM Clients WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Surname, FirstName, Patronymic, Address, Telephone FROM dbo.Clients";
        ...
        public virtual int Insert(string Surname, string FirstName, string Patronymic, string Address, string Telephone) {
            if ((Surname == null)) {
        ...
        public virtual int Update(string Surname, string FirstName, string Patronymic, string Address, string Telephone, int Original_Id, int Id) {
            if ((Surname == null)) {
                throw new global::System.ArgumentNullException("Surname");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Surname, string FirstName, string Patronymic, string Address, string Telephone, int Original_Id) {
            return this.Update(Surname, FirstName, Patronymic, Address, Telephone, Original_Id, Original_Id);
        }
    }
